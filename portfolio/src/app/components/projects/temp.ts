...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Implementation of consensus algorithms for decentralized state machines.',
    technologies: [],
    batch: 1,
  },
  {
    ...
    description: 'Firmware and coordination layer for low-power sensor networks.',
    technologies: [],
    batch: 1,
  },
  {
    ...
    description: 'Accessible, headless design system primitives for rapid application assembly.',
    technologies: [],
    batch: 2,
  },
  {
    ...
    category: 'SAAS',
    name: 'SaaS Starter',
    description: 'Monorepo boilerplate integrating auth, billing, and multi-tenancy.',
    technologies: [],
    batch: 2,
  },
  {
    ...
    description: 'Optimizing ONNX models for execution on resource-constrained microcontrollers.',
    technologies: [],
    batch: 2,
  },
];
